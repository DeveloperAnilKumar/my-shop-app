...
export default function ResetPassword() {
    ...
    const  [forgetPassword, setForgetPassword] = useState({password:"", conformPassword:""
    })
    ...
    return (
        <div className="w-screen h-[80vh] flex justify-center items-center">
            ...
            <div className=" w-[30rem] flex justify-center items-center ">
                ...
                <form className="shadow-lg p-8 rounded  w-full" onSubmit={submitHandler}>
                    ...
                    <Button variant="contained" type="submit"  className="w-full" size="small"> Reset Password </Button>
                    <div className=" mt-3">
                        <Divider>Or</Divider>
                        <p className="text-center"> Already have an account? <span className="text-blue-400"> <Link to="/login"> Login Now.</Link>.</span>
                        </p>
                    </div>
