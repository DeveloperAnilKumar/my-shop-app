...
export default function SignupForm() {
    ...
    const [formData, setFormData] = useState({
        firstName: "", lastName: "", email: "", password: "", conformPassword: "", role: "USER", otp: ""
    })
    ...
    async function submitHandler(e) {
        ...
        if (!formData.firstName || !formData.lastName || !formData.email || !formData.password || !formData.conformPassword || !formData.role || !formData.otp) {
            ...
            <div className=" w-[40rem] flex justify-center items-center ">
                ...
                <form className="shadow-lg p-8 rounded " onSubmit={submitHandler}>
                    ...
                    <div className=" w-full   flex-wrap flex justify-around gap-2 mb-3">
                        ...
                        )} variant="contained" className="w-[14rem]" size="small"> Reset </Button>
                        <Button type="submit" variant="contained" className="w-[14rem]" size="small"> SignUp </Button>
                    </div>
                    <div className=" mb-3">
                        <Divider>Or</Divider>
                        <p className="text-center"> Already have an account? <span
                            className="text-blue-400"> <Link to="/login"> Log in.</Link> </span>
                        </p>
                    </div>
