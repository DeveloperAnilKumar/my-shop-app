...
export default function Home({category}) {
    ...
    return (
        <div>
            <div
                className="relative   font-[sans-serif] m-1 before:absolute before:w-full before:h-full before:inset-0 before:bg-black before:opacity-50 before:z-10">
                <img
                ...
                <div
                    className="min-h-[300px] relative z-50 h-full max-w-6xl mx-auto flex flex-col justify-center items-center text-center text-white p-6">
                    <h2 className="sm:text-4xl text-2xl font-bold mb-6">Explore the World</h2>
                    <p className="text-lg text-center text-gray-200">Embark on unforgettable journeys. Book your dream
                        vacation today!</p>
                    <a href="#"
            ...
            <div data-aos="fade-left" data-aos-duration="2000" className=" bg-gray-50 px-4 py-10 font-[sans-serif]">
                <div className="max-w-7xl max-md:max-w-lg mx-auto">
                    <h2 className="text-3xl font-extrabold  text-center text-[#333]">TOP CATEGORIES</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
                            ...
                            <div className="bg-white cursor-pointer rounded overflow-hidden group">
                                ...
                                <div className="p-6 flex justify-center flex-col">
                                    <h3 className="text-xl font-bold text-center text-[#333] capitalize">{category[0]?.title}</h3>
                                    <button type="button"
                        ...
                        <div className="bg-white cursor-pointer rounded overflow-hidden group">
                            ...
                            <h3 className="text-xl font-bold text-center text-[#333] capitalize">{category[1]?.title}</h3>
                                <button type="button"
                                        className="px-4 py-2 mt-6 rounded text-white text-sm tracking-wider border-none outline-none bg-orange-500 hover:bg-orange-600">SHOP
                                    NOW
                        ...
                        <div className="bg-white cursor-pointer rounded overflow-hidden group">
                            ...
                            <div className="p-6 flex flex-col">
                            <h3 className="text-xl font-bold text-center text-[#333] capitalize">{category[2]?.title}</h3>
                                <button type="button"
                                        className="px-4 py-2 mt-6 rounded text-white text-sm tracking-wider border-none outline-none bg-orange-500 hover:bg-orange-600">
                                    SHOP NOW
                                </button>
            ...
            <div className=" m-1 bg-gradient-to-r from-purple-600 to-blue-600 font-[sans-serif] p-6">
                <div className="container mx-auto flex flex-col justify-center items-center">
                    ...
                    <p className="text-white text-base text-center mb-6">Elevate your style with our latest arrivals.
                        Shop now and enjoy exclusive discounts!</p>
                    <a href="#"
