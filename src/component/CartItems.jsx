...
import {decrementQuantity, incrementQuantity, removeCartItems} from "../Redux/slice/CartSlice.jsx";
        ...
        <>
            ...
            <div className="p-2 bg-white shadow-[0_0px_4px_0px_rgba(6,81,237,0.2)] rounded-md relative">
                <div className="grid sm:grid-cols-2 items-center gap-4">
                    ...
                    <div className="p-4">
                        <h3 className="text-xl font-extrabold text-[#333]">{item.product.name}</h3>
                        <hr className="my-6"/>
                        ...
                        <div className="flex items-center justify-between flex-wrap gap-4 mt-6">
                            ...
                            <div>
                                <h4 className="text-lg font-bold text-[#333]">{new Intl.NumberFormat("en-IN", {
                                    style: 'currency',
                                    currency: "INR"
                                }).format(item.product.price)}</h4>
                            </div>
                        </div>
                        <div className="divide-x border-y mt-6 grid grid-cols-2 text-center">
                            ...
                            <button type="button" onClick={removeToCartHandler}
                                    className="bg-transparent font-semibold py-3 text-gray-500 text-sm">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     className="w-3 fill-current mr-2 inline-block"
