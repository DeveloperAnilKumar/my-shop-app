                            ...
                            products.map((product) => {
                                return <div key={product._id}
                                    ...
                                    <div className="p-6 bg-white">
                                        ...
                                        <h4 className="text-lg text-gray-700 font-bold mt-2">${product.price}</h4>
                                        ...
                                        <div className="mt-3">

                                            {
                                                cartItems.some((p) => p.product._id === product._id) ? (
                                                    <Button onClick={(e)=>removeToCartHandler(e, product._id)}
                                                            color="error" variant="contained" className="w-full "> Remove To
                                                        Cart </Button>
                                                ) : (<Button onClick={(e) => addToCartHandler(e, product)}
                                                           variant="contained" className="w-full "> Add To
                                                        Cart </Button>
                                                )
                                            }
